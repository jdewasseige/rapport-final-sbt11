...
On décrira finalement les problèmes les difficultés auxquels nous avons été confrontés tout au long de ce projet.
...
sont présentés dans le tableau~\ref{fig:planning}
